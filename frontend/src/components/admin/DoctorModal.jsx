...
export default function DoctorModal({ doctor, onClose, onSuccess }) {
  ...
  useEffect(() => {
    if (doctor) {
      setForm({
        ...
        email: doctor.email || '',
        password: '',
        subscriptionPlan: doctor.subscriptionPlan || 'free',
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            >
              ...
              <option value="pro">Pro Plan (AI Features)</option>
            </select>
          </div>
